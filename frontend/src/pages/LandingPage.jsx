...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white overflow-hidden">
      ...
      {/* Combined Demo Section - AI Voice + CAD Dashboard Side by Side */}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg">
                AI voice conversation flows directly into the dispatcher dashboard in real-time
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold">AI Voice Conversation</h3>
                </div>
            ...
            <div className="text-center mt-8">
              ...
              <p className="text-center text-gray-500 text-sm mt-4">
                Call to see the AI conversation appear in the dashboard in real-time
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg">
                Powered by OpenAI Realtime API for true voice-to-voice conversation
              </p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h4 className="font-bold">AI Capabilities</h4>
                  </div>
                  <ul className="space-y-2 text-sm text-gray-300">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                      <span>Asks for location first, then caller name</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                      <span>Uses caller's name strategically to build rapport</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                      <span>Filters background noise naturally</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                      <span>Maintains calm, professional demeanor</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                      <span>Creates CAD entries automatically</span>
                    </li>
                  </ul>
                </div>
              </div>
